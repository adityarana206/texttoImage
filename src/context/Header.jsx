...
const Header = () => {
  ...
  return (
    ...
    >
      <motion.div
        className="text-stone-500 inline-flex text-center gap-3 bg-white px-6 py-1 rounded-full border border-neutral-500"
        initial={{ opacity: 0.2, y: 100 }}
      ...
      <motion.h1
        className="text-4xl max-wp[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
